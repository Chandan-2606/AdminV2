    ...
    <div class="card">
      <div class="card-body register-card-body ">
        ...
        <form action="registerC.php" method="post">
          ...
          <div class="error text-danger pl-1 mb-3">
            <?php
          ...
          <div class="input-group">
            <input type="password" class="form-control"
              placeholder="Retype password" id="password2" name="password2" required>
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-lock"></span>
              </div>
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-12">
              <button type="submit" class="my-2 btn btn-primary btn-block">Register</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
