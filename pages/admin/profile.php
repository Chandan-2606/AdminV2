                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    ...
                                    <h3 class="profile-username text-center"><?php echo $_SESSION['adminName']; ?></h3>
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="settings">
                                            <form action="uploadC.php" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea class="form-control" id="inputExperience" placeholder="Note"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputStatus" class="col-sm-2 col-form-label">Make Admin</label>
                                                    <div class="col-sm-10">
